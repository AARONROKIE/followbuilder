# Follow Builder — AI Builders 晨报（含 A 股+港股 AI 影响分析）

> **改进行声明：** 本技能基于 Zara Zhang 的 [Follow Builders](https://github.com/zarazhangrui/follow-builders) 技能进行深度改进。原始技能专注于追踪 AI 领域真正的建设者（Builders），本改进版在保留其核心数据管线的基础上，新增**橙红渐变晨报风 HTML 输出**和**A 股+港股 AI 板块影响分析**功能——当 AI 大事件发生时，自动研判对 A 股/港股相关上市公司的股价、资金流向与估值影响，为投资决策提供及时的交叉参考。
...
| 9 | **📈 A 股+港股 AI 影响分析** 🆕 | 整合同花顺问财、通达信、NeoData、WeStock 等金融数据源，当 AI 重大事件发生时，自动研判对 A 股/港股 AI 相关上市公司（如科大讯飞、商汤、百度、小米等）的股价、资金流向、北向资金动态及估值影响，为投资者提供"AI 新闻→个股影响"的一站式交叉参考 |
...
| 📈 股票市场分析 | Stock Market Analysis | AI 板块行情、上市公司股价、资金流向、券商研报、市值动态 |
...
<body>
  ...
  <header class="hero">
    <div class="hero-content">
      ...
      <div class="hero-stats">
        ...
        <span class="stat-item">📈 股票市场: X条</span>
      </div>
    </div>
  </header>
  ...
  <main class="content">
    ...
    <section id="section-stocks" class="section-block">...</section>
  </main>

  <!-- ===== 4. 页脚 ===== -->
  <footer class="footer">
    共 N 条资讯 | 数据来源: X/Twitter, YouTube Podcasts, AI Blogs, Stock Market Data | Generated by Follow Builder
  </footer>
...
.source-chip.stock { background: #FCE4EC; color: #C62828; }
...
- 响应式卡片网格与滚动动画
- 纯内联 HTML/CSS/JS 架构
- 📈 股票市场分析板块 — 整合同花顺问财、通达信、NeoData、WeStock 等金融数据源，覆盖 AI 板块行情、资金流向、券商研报、市值动态
